class Tutorial {
    constructor(game) {
        ...
        this.steps = [
            ...
            {
                message: "Алгоритм Краскала - это алгоритм поиска минимального остовного дерева в графе. Он работает следующим образом:\n\n1. Сортируем все рёбра графа по весу\n2. Начинаем с пустого графа\n3. Добавляем рёбра по одному, начиная с самых лёгких\n4. Пропускаем рёбра, которые создают цикл\n5. Продолжаем, пока не соединим все вершины",
                highlight: null
            },
            {
                message: "В нашем случае:\n- Вершины - это города\n- Рёбра - это дороги между городами\n- Вес ребра - это стоимость строительства дороги\n\nНаша цель - соединить все города с минимальной общей стоимостью.",
                highlight: null
            },
            {
                message: "Перед вами 4 города. Ваша задача - соединить их с минимальной стоимостью.",
                highlight: null
            },
            {
                message: "Нажмите на два города, чтобы соединить их. Стоимость соединения показана на ребре.\n\nПопробуйте найти оптимальное решение самостоятельно!",
                highlight: null,
                isLast: true
            }
        ];
